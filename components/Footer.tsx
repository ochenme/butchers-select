    ...
    <footer className="bg-gray-100 border-t border-gray-200 py-8 mt-16">
      <div className="container mx-auto px-4 text-center text-gray-600 text-sm">
        <div className="flex flex-col items-center space-y-2">
          ...
          <p><span className="font-semibold">公司地址：</span> 新北市樹林區佳園路３段１４２號４樓</p>
          <p><span className="font-semibold">聯絡電話：</span> 0986500440</p>
          <p>
            <span className="font-semibold">官方社群：</span>
            <a 
              href="https://line.me/ti/g2/lJdWX95qdVDUik_4o3JZ6LhySZnolzheLuYtjg?utm_source=invitation&utm_medium=link_copy&utm_campaign=default" 
              target="_blank" 
