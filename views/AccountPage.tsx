                        ...
                        {isEditing ? (
                          <>
                            <input
                              type="text"
                              value={editSevenCity}
                              onChange={(e) => setEditSevenCity(e.target.value)}
                              placeholder="城市"
                              className="w-full bg-white border border-amber-200 rounded-md px-3 py-2 text-sm text-zinc-900 focus:outline-none focus:ring-2 focus:ring-amber-500"
                            />
                            <input
                ...
                <div className="grid gap-4 md:grid-cols-3">
                  <div className="bg-white border border-gray-200 rounded-lg p-4 space-y-2">
                    ...
                    <input
                      ...
                      className="w-full bg-gray-50 border border-amber-200 rounded-md px-3 py-2 text-sm text-zinc-900 focus:outline-none focus:ring-2 focus:ring-amber-500"
                      placeholder="請輸入收件地址"
                    />
                  </div>
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-4 space-y-2">
                    ...
                    <div className="grid gap-2">
                      <input
                        ...
                        onChange={(event) => setRegisterSevenCity(event.target.value)}
                        className="w-full bg-gray-50 border border-amber-200 rounded-md px-3 py-2 text-sm text-zinc-900 focus:outline-none focus:ring-2 focus:ring-amber-500"
                        placeholder="城市"
                      />
                      <input
